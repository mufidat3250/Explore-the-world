...
const HomePage = () => {
  return (
    <div className="homePage">
      ...
      <div className="flex flex-col space-y-5 md:space-y-0 md:flex-row justify-between  my-20 md:my-[4.25rem] font-[Heldene-display] px-[1rem] " id={'room'}>
          <div className="">
          ...
          <div>
           ...
           <div className="container">
           <div className="md:max-w-[55%] lg:max-w-[70%] px-4 md:pl-12 text-[1.375rem] pt-[4.875rem] pb-[6.875rem] space-y-[2.0625rem] text-[#654b37]">
